...
import { Edit2, Merge, Split, Trash2, Save, ChevronDown, ChevronUp, Loader2 } from 'lucide-react'
...
interface DocumentChunksDrawerProps {
        ...
        <SheetContent className="w-full sm:max-w-2xl overflow-y-auto">
          <SheetHeader className="pb-4">
            <SheetTitle className="flex items-center justify-between">
              <span className="truncate pr-4">切块详情: {documentName}</span>
